...
const Navbar = () => {
    ...
    return (
        <nav className="w-full bg-blue-600 fixed top-0 left-0 h-16 px-4 z-50">
                    ...
                    {loggedIn ? (
                        <>
                            ...
                            <li>
                                <button
                                    onClick={signOut}
                                    className="cursor-pointer relative flex items-center h-full px-4 text-white transition-colors duration-100 hover:text-yellow-300"
                                >
